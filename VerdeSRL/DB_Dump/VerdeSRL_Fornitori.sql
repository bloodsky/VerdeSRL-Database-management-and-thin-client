...
CREATE TABLE `Fornitori` (
  `CodiceFornitori` int(11) NOT NULL AUTO_INCREMENT,
  `CodiceFiscale` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Nome` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Indirizzo` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`CodiceFornitori`)
...
INSERT INTO `Fornitori` VALUES (1,'FN23RETY678AHSA133','Bucci','via Francia'),(2,'AS2DREJK658XRSO153','Del Santo','via Nazionale'),(3,'OP13REHH478EESI073','Gizzi','via Atleti'),(4,'ZZ83RERG778TDUA093','Martelletti','via Geronimo'),(5,'TA93SAER777GRSA903','Bugliari','viale Primo');
