...
CREATE TABLE `Privati` (
  ...
  CONSTRAINT `Privati_ibfk_1` FOREIGN KEY (`CodiceCliente`) REFERENCES `Clienti` (`CodiceCliente`)
...
INSERT INTO `Privati` VALUES (1,'RS34TTY6770K0FKFS33'),(2,'BNC456JBB33BEJBE33J');
